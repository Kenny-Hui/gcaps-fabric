...
public class CapModel {
    ...
    public static ArmorMaterial ARMOR_MATERIAL = new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), map -> map.put(ArmorItem.Type.BODY, 1)), 15, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, () -> Ingredient.ofItems(Main.CAPS), null, 0, 0);
